...
Het is mogelijk de toestand van een systeem te veeranderen zonder arbeid te verichten. 
...
\begin{itemize}
    ...
    \item Behoud energie
    \item Defiinitie van qarmte als energieoverdracht als gevolg van een temperatuurverschil.
\end{itemize}
...
\[U(T,V) \implies dU = \left( \frac{\partial U}{\partial T} \right)_V dT + P \left( \frac{\partial U}{\partial V} \right)_T dV\]
\[U(P,T) \implies dU = \left( \frac{\partial U}{\partial P} \right)_T dP + \left( \frac{\partial U}{\partial T} \right)_P dT\]
\begin{align*}
    C_V &= \left( \frac{\dbar Q}{dT} \right)_V = \left( \frac{dU}{dT} \right)_V \\
    C_P &= \left( \frac{\dbar Q}{dT} \right)_P = \left( \frac{dU}{dT} \right)_P + P \left( \frac{dV}{dT} \right)_P
\end{align*}
...
\begin{derivation}
    ...
    \begin{figure}[ht]
        ...
        \caption{Schematische weergave van de methode van Rüchardt.}
    ...
    waarbijg een klein volumeveranderin.
