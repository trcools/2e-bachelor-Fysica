...
\begin{figure}[htp]
    ...
    \caption{VT-diagram van een zuivere stof. De verschillende lijnen en gebieden geven de verschillende fasen en evenwichten aan. \tiny \copyright{Olivier Cleynen is licensed under a CC0 (Creative Commons Zero) license}}
...
\begin{figure}
    ...
    \caption{PV-diagram van water. De verschillende lijnen en gebieden geven de verschillende fasen en evenwichten aan. \tiny \copyright{Olivier Cleynen is licensed under a CC0 (Creative Commons Zero) license}}
...
\begin{figure}[h]
    ...
    \caption{PVT-diagram van een zuivere stof. De verschillende lijnen en gebieden geven de verschillende fasen en evenwichten aan.\tiny\copyright{ vectorization is licensed under a CC0 (Creative Commons Zero) license.}}
...
\[V_\epsilon = V_{\epsilon,25} + \alpha (T'-25^\circ C) + \beta (T'-25^\circ C) + \gamma (T' - 25^\circ C)^3\]
