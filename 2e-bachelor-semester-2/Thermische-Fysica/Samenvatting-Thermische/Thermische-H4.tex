...
\[
W \approx \frac{\kappa V}{2} (P_i^2 - P_f^2) = \frac{\kappa m}{2\rho} (P_i^2 - P_f^2) \qquad (T = cst)
\]
Waar we gebuik hebben gemaakt van \(V = \frac{m}{\rho}\) met \(m\) de massa en \(\rho\) de dichtheid van de vaste stof.
...
\begin{figure}[ht]
    ...
    \caption{Een samengesteld systeem.  \footnotesize \copyright{Wikipedia contributer}}
