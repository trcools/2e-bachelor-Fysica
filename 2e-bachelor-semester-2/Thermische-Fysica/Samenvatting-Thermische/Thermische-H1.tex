...
Het eerste deel van de cursus gaat over de macroscopische beschrijving van de thermische fysica. Dit wil zeggen op grote schaal. Later vanaf hoofdstuk 10 zullen we ook dee microscopische beschijvingen behandelen.
\subsection{Microscopisch en Macroscopisch}

\begin{itemize}
    \item Macroscopisch: 
    
    Behoord tot de klassieke thermodynamica. Hierin worden grootheden zoals druk, volume, temperatuur en energie gebruikt. Deze grootheden zijn gemiddeldes van microscopische grootheden.
    \item Microscopisch:
    
    Behoord tot de statistische mechanica. Hierin worden grootheden zoals de positie en snelheid van individuele deeltjes gebruikt, en ook de individuele eigen energien. Deze grootheden worden vaak achteerhaald met behulp van partitiefuncties en waarschijnlijkheidsverdelingen. 
\end{itemize}
...
\begin{itemize}
    ...
    \item Thermische interacties (adiabatische wandn \(\implies\) geen thermische interacties, diathermische wanden \(\implies\) wel thermische interacties)
