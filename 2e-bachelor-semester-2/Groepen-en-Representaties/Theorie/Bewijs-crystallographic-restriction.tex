...
\begin{proof}
    ...
    \[
        ...
        \end{pmatrix}
    \]
    De trace van \(O_g\) is gelijk aan \(1 + 2\cos(\frac{2\pi}{n})\).

    Deze gehele getallen die ervoor zorgen dat de trace een geheel getal is, zijn \(3, 1, 0, -1\) of \(-2\), wat overeenkomt met \(n = 1, 2, 3, 4\) of \(6\).
    \begin{itemize}
        \item \(1 + 2\cos(\frac{2\pi}{1}) = 3\)
        \item \(1 + 2\cos(\frac{2\pi}{2}) = 1\)
        \item \(1 + 2\cos(\frac{2\pi}{3}) = 0\)
        \item \(1 + 2\cos(\frac{2\pi}{4}) = -1\)
        \item \(1 + 2\cos(\frac{2\pi}{6}) = -2\)
    \end{itemize}
\end{proof}