...
\]
Dit is precies de orthonormaliteitsrelatie. Equivalent: het is de uitspraak $\braket{\gamma s i_3 | \gamma' s' i_3'} = \delta_{\gamma\gamma'}\delta_{ss'}\delta_{i_3i_3'}$, geschreven in de productbasis.

\textbf{Compleetheid.}
Schrijf nu de tweede relatie ($CC^\dagger = \mathds{1}$) uit:
\[
