...
\begin{theorem}[Lagrange Theorem]
    ...
    En de elementen van \(G/H\) zijn disjunte subsets van \(G\) waarbij elke coset hezelfde aantal elementen bevat als \(H\).
    ...
    We kunnen dit opnieuw doen voor een set \(H''=Hg_2\) met \(g_2 \in G\) en \(g_2 \notin \{H, H'\}\).
    ...
    Dan wordt het gevraagde \(\frac{|G|}{|H|} = \frac{h |H| }{|H|} = k \in \mathbb{N}\).
