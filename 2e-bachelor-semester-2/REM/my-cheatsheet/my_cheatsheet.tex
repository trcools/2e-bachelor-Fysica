...
Bound charge (hom isotr lin dielec):
...
Total em force on a charge distribution:
...
ElMag contributions to energy density equal:
...
Osc el dip:
\(\bm p(t) = \bm p_0 \cos(\omega t) \hat{\bm z}\) and \(p_0 = q_0d\)
