...
Neuman's law:
\(M_{21} = M_{12} = \frac{\mu_0}{4\pi} \oint \oint \frac{d\bm l_1 \cdot d\bm l_2}{r_c}\)
...
\(\bm \nabla V = \frac{1}{4\pi \epsilon_0} \int [(\bm \nabla \rho) \frac{1}{r_c} + \rho \bm \nabla (\frac{1}{r_c})] d\tau'\)

\(\bm \nabla \rho = \dot{\rho} \bm \nabla t_r = -\frac{1}{c}\dot{\rho} \bm \nabla r_c\)

\(\bm \nabla r_c = \hat{\bm r}_c\); \(\bm \nabla (\frac{1}{r_c}) = -\frac{\hat{\bm r}_c}{r_c^2}\)

\(\bm \nabla \dot{\rho} = - \frac{1}{c} \ddot{\rho} \bm \nabla r_c = -\frac{1}{c}\ddot{\rho} \hat{\bm r}_c\)
...
Adv. Potentials:
\(V_a(\bm r, t) = \frac{1}{4 \pi \epsilon_0} \int \frac{\rho(\bm r', t_a)}{r_c} d\tau'\)

and
\(\bm A_a(\bm r, t) = \frac{\mu_0}{4\pi} \int \frac{\bm J(\bm r', t_a)}{r_c} d\tau'\)


\(\bm \nabla (\frac{\bm J}{r_c}) = \frac{1}{r_c}(\bm \nabla \cdot \bm J) + \frac{1}{r_c}(\bm \nabla ' \cdot \bm J ) - \bm \nabla ' \cdot (\frac{\bm J}{r_c}) \)

\(\bm \nabla \times \bm J = \frac{1}{c}\dot{\bm J} \times \hat{\bm r}_c\); \(\qquad\)
\(\frac{\partial \bm A}{\partial t} = \frac{\mu_0}{4\pi}\int \frac{\dot{\bm J}}{r_c}d\tau'\)

Jefimenko's equations:
\(\bm E(\bm r, t) = \frac{1}{4\pi \epsilon_0} \int [ \frac{\rho(\bm r', t_r)}{r_c^2} \hat{\bm r}_c + \frac{\dot{\rho}(\bm r', t_r)}{c r_c} \hat{\bm r}_c - \frac{\dot{\bm J}(\bm r', t_r)}{c^2 r_c} ] d\tau'\)   

\(\bm B(\bm r, t) = \frac{\mu_0}{4\pi} \int [ \frac{\bm J(\bm r', t_r)}{r_c^2} + \frac{\dot{\bm J}(\bm r', t_r)}{c r_c} ] \times \hat{\bm r}_c d\tau'\)  
...
Vel. charge ret. time:
\(\int \rho(\bm r', t_r)d\tau ' = \frac{q}{1-\hat{\bm r}_c \cdot \frac{\bm v}{c}}\)

Apparant vol \(\tau '\) and actual vol \(\tau\):
\(\tau' = \frac{\tau}{1-\hat{\bm r}_c \cdot \frac{\bm v}{c}}\)

Fields for a moving point charge:
\(\bm u \equiv c \hat{\bm r}_c - \bm v\)

\(\bm E(\bm r, t) = \frac{q}{4\pi \epsilon_0} \frac{r_c}{(\hat{\bm r}_c \cdot \bm u)^3 r_c^2} [(c^2-v^2)\bm u + \bm r_c \times (\bm u \times \bm a)]\)  

\(\bm B(\bm r, t) = \frac{1}{c}\hat{\bm r}_c \times \bm E(\bm r, t)\)

Resulting force:

\(\bm F = \frac{qQ}{4\pi \epsilon_0}\frac{r_c}{(\hat{\bm r}_c \cdot \bm u)^3}\{[(c^2-v^2)\bm u + \bm r_c \times (\bm u \times \bm a)] + \frac{\bm V}{c}\times[\hat{\bm r}_c \times [(c^2-v^2) \bm u + \bm r_c \times (\bm u \times \bm a)]]\}\)
...
\(\hat{\bm r}_c = \frac{\bm r - \bm v t_r}{r_c} = \frac{(\bm r - \bm v t) + (t - t_r) \bm v}{r_c} = \frac{\bm R}{r_c} + \frac{\bm v}{c}\)


\(\bm B = \frac{1}{c}(\bm r_c \times \bm E) = \frac{1}{c^2}(\bm v \times \bm E)\);
\(\frac{\partial t_r}{\partial t} = \frac{cr_c }{\bm r_c \cdot \bm u}\)
...
\(\bm A (\bm r,t) = \frac{\mu_0}{4\pi} \int_{-d/2}^{d/2} \frac{-q_0 \omega \sin(\omega (t - \frac{r_c}{c})) \hat{\bm z}}{r_c} dz\)
