...
\linespread{0.8} % Dit kan op het einde nog worden aangepast naargemate er plaats over is.
\pagestyle{empty}
...
\par\vspace{1.8pt}%
\noindent\colorbox{hdrcol}{\parbox[c][1.0em][c]{0.98\linewidth}{\color{white}\bfseries\small #1}}\par
\vspace{1pt}%
}
...
\secblock{H2 Electrostatics}
    ...
    Coulomb Force: 
    \(\bm F = \frac{1}{4\pi \epsilon_0}\frac{qQ}{r^2}\hat{\brcurs}\)

    Force on Q: \(\bm F = Q \bm E\)
    
    Coulomb's law:
    \(
    \bm E (\bm r) = \frac{1}{4\pi \epsilon _0} \int \frac{\rho(\bm r ')}{\rcurs^2}\hat{\brcurs} d\uptau'
    \)

    Electric flux: 
    \(
    \Upphi_E = \int_S \bm E \cdot d\bm a
    \)
    ...
    \(V(\bm r) =-\int_O^r \bm E \cdot d \bm l \implies \bm E = - \bm\nabla V \)
    ...
    Boundary conditions:
    \(E_1^{\parallel} = E_2^{\parallel}\); \(E_1^{\perp} - E_2^{\perp} = \frac{\sigma}{\epsilon_0}\)
    ...
    \(\bm f = \frac{1}{2 \epsilon_0}  \sigma^2 \hat{\bm n}\);
...
Pot. Macr. field:
\(
V (\bm r) = \frac{1}{4 \pi \epsilon_0} \int \frac{\bm P(\bm r') \cdot \hat{\bm r_{c}}}{\rcurs^2} d\uptau'
\)

\(\bm p = \frac{4\pi R^3}{3}\bm P\);
\(\qquad \bm \nabla \times \bm D = \bm \nabla \times \bm P\)
...
Work:
\(
\frac{1}{2} \int \bm D \cdot \bm E d\uptau
\)
...
\(
\bm J = \frac{d \bm I}{da_\perp} = \rho \bm v
\)
...
\(
\bm F_{mag} =  \int ( \bm v \times \bm B)\rho d\uptau =  \int ( \bm J \times \bm B)d\uptau
\)
...
\(
\bm{B}(\bm{r})=\frac{\mu_0}{4\pi}\int\frac{\bm I\times\hat{\brcurs}}{\rcurs^2}dl'
=\frac{\mu_0 I}{4\pi}\int\frac{d \bm l'\times\hat{\brcurs}}{\rcurs^2}
\)


\(\bm{B}(\bm{r})=\frac{\mu_0}{4\pi}\int\frac{\bm K(\bm r')\times\hat{\brcurs}}{\rcurs^2}d a' =\frac{\mu_0}{4\pi}\int\frac{\bm J(\bm r')\times\hat{\brcurs}}{\rcurs^2}d \uptau '\)

Vector potential in magnetostatics:

\(\bm A = \frac{\mu_0}{4\pi}\int\frac{\bm J(\bm r')}{\brcurs}d \uptau '\);
...
Sph shell \(A/q = \sigma\), ang vel \(\omega\):
\(\bm B_{in} = \frac{2}{3} \mu_0 \sigma \omega R \hat{\bm z}\)
...
Boundary:
\(\bm B_1^{\parallel} - \bm B_2^{\parallel} = \mu_0(\bm K \times \hat{\bm n})\)
...
\(\bm A (\bm r) = \frac{\mu_0}{4\pi} \frac{\bm m \times \hat{\brcurs}}{\rcurs^2} = \frac{\mu_0}{4\pi} \int \frac{\bm M (\bm r) \times \hat{\brcurs}}{\rcurs^2} d\uptau'\)
...
Energy mag dipole \(\bm m\) in field \(\bm B\):
\(U = -\bm m \cdot \bm B\)
...
Resistivity:
\(\rho = \frac{1}{\sigma}\) \textbf{(\(\sigma\) is not surface charge!)}
...
Flux rule:
\(\epsilon_{emf} = -\frac{d \Upphi}{dt}\); 
\(\Upphi = \int \bm B \cdot d\bm a\)

Analog Biot-Savart:
\(\bm{E}(\bm{r})=-\frac{1}{4\pi}\frac{\partial}{\partial t}\int\frac{\bm B\times\hat{\brcurs}}{\rcurs^2}d\bm \uptau'\)

Inductance:
\(\bm B_1 = \frac{\mu_0 I_1}{4\pi} \oint \frac{dl_1 \times \hat{\brcurs}}{\rcurs^2}\)

Mutual inductance:
\(\Upphi_{21} = \int \bm B_1 \cdot d\bm a_2 = M_{21} I_1\)

Neuman's law:
\(M_{21} = M_{12} = \frac{\mu_0}{4\pi}  \oint \frac{d\bm l_1 \cdot d\bm l_2}{\rcurs}\)

Self inductance:

\(\Upphi_{11} = \int \bm B_1 \cdot d\bm a_1 = L I_1 \implies \Upphi = LI\)
...
\(W = \frac{1}{2\mu_0} \int_{all \, space} B^2 d\uptau\)
...
\(\bm J_d = \epsilon_0 \frac{\partial \bm E}{\partial t} =  \frac{\partial \bm D}{\partial t}\)
...
\(\frac{dW}{dt} = \int_{V} (\bm E \cdot \bm J) d\uptau\) then (\(\bm J \) to field (D.4))
...
\(\bm F = \int_V \bm f d\uptau = \int_V (\rho \bm E + \bm J \times \bm B) d\uptau \) (D.1, D.4)   

\(
\partial_t (\bm E \times \bm B) = \partial_t\bm E \times \bm B + \bm E \times \partial_t \bm B
\) (D.3)

Add \(\bm \nabla \cdot \bm B=0\) and use (A.4) twice
...
%\(\bm F = \int \bm f d\uptau = \oint_S \overleftrightarrow{T} \cdot d\bm a - \epsilon_0 \mu_0 \frac{d}{dt} \int_V \bm S d\uptau\)   
...
\(\bm p = \mu_0 \epsilon_0 \int \bm S d\uptau  \)

Conservation of momentum:
\(\frac{d\bm p}{dt} + \oint_S \overleftrightarrow{T} \cdot d\bm a = 0\)

Momentum density: 
\(\bm g =  \mu_0 \epsilon_0 \bm S = \epsilon_0 (\bm E \times \bm B)\)


Continuity eq for momentum:
...
\(\qquad \langle \bm g \rangle = \frac{1}{2} \frac{u}{c} \hat{\bm z}\)

\(\langle u \rangle = \frac{1}{2} \epsilon_0 E_0^2\);
\(\qquad \langle \bm S \rangle = \frac{1}{2} c \epsilon_0 E_0^2 \hat{\bm z}\)
...
Light medium:
\(v = \frac{c}{n}\)
with \(n \equiv \sqrt{\frac{\epsilon \mu}{\epsilon_0 \mu_0}} \approx \sqrt{\epsilon_r}\)
...
Retarded time:
\(t_r = t - \frac{\rcurs}{c}\) \(\implies \partial_{t}t_r = \partial_tt\) 

Ret. Potentials:
\(V(\bm r, t) = \frac{1}{4 \pi \epsilon_0} \int \frac{\rho(\bm r', t_r)}{\rcurs} d\uptau'\)

and
\(\bm A(\bm r, t) = \frac{\mu_0}{4\pi} \int \frac{\bm J(\bm r', t_r)}{\rcurs} d\uptau'\)

Note: this logic doesn't apply to the fields!


\(\bm \nabla V = \frac{1}{4\pi \epsilon_0} \int [(\bm \nabla \rho) \frac{1}{\rcurs} + \rho \bm \nabla (\frac{1}{\rcurs})] d\uptau'\)

\(\bm \nabla \rho = \dot{\rho} \bm \nabla t_r = -\frac{1}{c}\dot{\rho} \bm \nabla \rcurs;
\bm \nabla \dot{\rho} = - \frac{1}{c} \ddot{\rho} \bm \nabla \rcurs = -\frac{1}{c}\ddot{\rho} \hat{\brcurs}\)


\(\bm \nabla \rcurs = \hat{\brcurs}\); \(\bm \nabla (\frac{1}{\rcurs}) = -\frac{\hat{\brcurs}}{\rcurs^2}\)


\(\nabla^2 V = \frac{1}{4\pi \epsilon_0} \int [\frac{1}{c^2}\frac{\ddot{\rho}}{\rcurs} - 4 \pi \rho \delta^3(\brcurs)] d\uptau' = \frac{1}{c^2} \frac{\partial^2 V}{\partial t^2} - \frac{\rho}{\epsilon_0}\)

Advanced time:
\(t_a = t + \frac{\rcurs}{c}\)

Adv. Potentials:
\(V_a(\bm r, t) = \frac{1}{4 \pi \epsilon_0} \int \frac{\rho(\bm r', t_a)}{\rcurs} d\uptau'\)

and
\(\bm A_a(\bm r, t) = \frac{\mu_0}{4\pi} \int \frac{\bm J(\bm r', t_a)}{\rcurs} d\uptau'\)


\(\bm \nabla (\frac{\bm J}{\rcurs}) = \frac{1}{\rcurs}(\bm \nabla \cdot \bm J) + \frac{1}{\rcurs}(\bm \nabla ' \cdot \bm J ) - \bm \nabla ' \cdot (\frac{\bm J}{\rcurs}) \)

\(\bm \nabla \times \bm J = \frac{1}{c}\dot{\bm J} \times \hat{\brcurs}\);
...
Slow current change
\(\bm J(t_r) \approx \bm J(t) - (t-t_r) \dot{\bm J}(t)\)


Jefimenko's equations:
\(\bm E(\bm r, t)\)

\( = \frac{1}{4\pi \epsilon_0} \int [ \frac{\rho(\bm r', t_r)}{\rcurs^2} \hat{\brcurs} + \frac{\dot{\rho}(\bm r', t_r)}{c \rcurs} \hat{\brcurs} - \frac{\dot{\bm J}(\bm r', t_r)}{c^2 \rcurs} ] d\uptau'\)   

\(\bm B(\bm r, t) = \frac{\mu_0}{4\pi} \int [ \frac{\bm J(\bm r', t_r)}{\rcurs^2} + \frac{\dot{\bm J}(\bm r', t_r)}{c \rcurs} ] \times \hat{\brcurs} d\uptau'\)  


Liénard-Wiechert potentials:

\(\bm A(\bm r, t) = \frac{\mu_0}{4\pi} \int \frac{\bm J(\bm r', t_r)}{\rcurs} d\uptau'\); \(\bm J = \rho \bm v \implies\)

\( = \frac{\mu_0}{4\pi} \int \frac{\rho(\bm r', t_r) \bm v (t_r)}{\rcurs} d\uptau' 
= \frac{\mu_0 \bm v}{4\pi \rcurs}\int \rho(\bm r', t_r)   d\uptau'\)

\(V(\bm r, t) = \frac{1}{4 \pi \epsilon_0} \int \frac{\rho(\bm r', t_r)}{\rcurs} d\uptau'\)  

Vel. charge ret. time:
\(\int \rho(\bm r', t_r)d\uptau ' = \frac{q}{1-\hat{\brcurs} \cdot \frac{\bm v}{c}}\)

Apparant vol. \(\uptau '\) and act. vol. \(\uptau\):
\(\uptau' = \frac{\uptau}{1-\hat{\brcurs} \cdot \frac{\bm v}{c}}\)
...
\(|\bm r - \bm w (t_r)| = c(t-t_r)\)

\(\brcurs = \bm r - \bm w (t_r) = \bm r - \bm v (t_r)\)

\(\hat{\brcurs} = \frac{\bm r - \bm v t_r}{c(t-t_r)} = \frac{\bm r - \bm v t_r}{\rcurs} = \frac{(\bm r - \bm v t) + (t - t_r) \bm v}{\rcurs} = \frac{\bm R}{\rcurs} + \frac{\bm v}{c}\)
...
\(\bm F = \frac{qQ}{4\pi \epsilon_0}\frac{\rcurs}{(\brcurs \cdot \bm u)^3}\{[(c^2-v^2)\bm u + \brcurs \times (\bm u \times \bm a)] + \frac{\bm V}{c}\times[\hat{\brcurs} \times [(c^2-v^2) \bm u + \brcurs\times (\bm u \times \bm a)]]\}\)

Fields moving charge non-rel lim: 
\(\bm R \equiv \bm r - \bm v t\)

\(\bm E(\bm r, t) = \frac{q}{4\pi \epsilon_0} \frac{1- v^2/c^2}{(1 - \frac{v^2 \sin^2\theta}{c^2})^{3/2}} \frac{\hat{\bm R}}{R^2} \approx \frac{1}{4\pi \epsilon_0} \frac{q}{R^2}\hat{\bm R}\)


\(\bm B (\bm r, t) = \frac{\mu_0}{4\pi} \frac{1- v^2/c^2}{(1 - \frac{v^2 \sin^2\theta}{c^2})^{3/2}} \frac{\hat{\bm R} \times \bm v}{R^2} \approx \frac{\mu_0}{4\pi} \frac{q}{R^2}(\bm v \times\hat{\bm R})\)




\(\bm B = \frac{1}{c}(\hat{\brcurs} \times \bm E) = \frac{1}{c^2}(\bm v \times \bm E)\);
\(\frac{\partial t_r}{\partial t} = \frac{c\rcurs }{\brcurs \cdot \bm u}\)
...
\(\bm A (\bm r,t) = \frac{\mu_0}{4\pi} \int_{-d/2}^{d/2} \frac{-q_0 \omega \sin(\omega (t - \frac{\rcurs}{c})) \hat{\bm z}}{\rcurs} dz\)
...
\(\bm S = \frac{1}{\mu_0} (\bm E \times \bm B) = \frac{\mu_0 p_0^2 \omega^4}{16 \pi^2 c} \frac{\sin^2\theta}{r^2} \cos^2[\omega(t - \frac{r}{c})]\hat{\bm r}\)  

Intensity:
\(I(r, \theta) = \langle S \rangle = \frac{\mu_0 p_0^2 \omega^4}{32 \pi^2 c} \frac{\sin^2\theta}{r^2}\hat{\bm r}\)   
...
Einstein vel. addition:
\(v_{ab} = \frac{v_a + v_b}{1 + v_a v_b/c^2}\)

Time dilation:
\(\Delta t_{obs, ground} = \gamma \Delta t_{moving\,system}\)

Length contraction:
\(\Delta x_{obs, ground} = \frac{\Delta x_{moving}}{\gamma}\)
...
Lorentz transformations then are
...
Proper time:
\(d\uptau = \sqrt{1 - \beta_u^2}dt \equiv \frac{dt}{\gamma_u}\)

Proper velocity:
\(\bm \eta = \frac{d\bm l}{d\uptau} = \gamma_u \bm u\) 

Ordinary velocity:
\(\bm u = \frac{d\bm l}{dt}\)

\(\eta_0 = \frac{dx^0}{d\uptau} = c \frac{dt}{d\uptau} = c\gamma_u\);
\(\eta'^\mu \equiv \bar{\eta}^\mu = \Lambda_\nu^\mu \eta^\nu\)

\(\bm u'_\parallel = \frac{\bm u_\parallel-\bm v}{1 - u_\parallel v/c^2}\) ; \(\bm u'_\perp = \frac{\bm u_\perp}{\gamma (1 - u_\parallel v/c^2)}\)

Relativistic momentum:
\(\bm p \equiv  m \eta =  \gamma_u m \bm u\)
...
special case if \(\bm u = 0\) 
\(\bm F'_{\perp} = \frac{1}{\gamma} \bm F_{\perp}\) ; \(\bm F'_{\parallel} = \bm F_{\parallel}\)

Proper force:
\(\bm K = \frac{dt}{d\uptau} \frac{d\bm p}{dt} = \gamma_u \bm F\) ; \(K^0 = \frac{1}{c} \frac{dE}{d\uptau}\)
...
Proper acc:
\(\bm \alpha^\mu \equiv \frac{d\eta^\mu}{d \uptau} = \frac{d^2 x^\mu}{d \uptau^2}\);
\(\eta^\mu \alpha_\mu = 0\)
...
\(E = \frac{\lambda_{tot}}{2 \pi \epsilon_0 s}\);
\(F' = qE = - \frac{\lambda v}{\pi \epsilon_0 c^2} \frac{qu}{s}\)

\(F = \frac{F'}{\gamma_u} = - \frac{\lambda v}{\pi \epsilon_0 c^2} \frac{qu}{s \gamma_u} = -qu \frac{\mu_0 \bm I}{2 \pi s}\)
...
\(\frac{d \gamma}{d t} =\gamma^3 \frac{\bm u}{c^2} \frac{d \bm u}{dt}\);
\(
\frac{d}{dt} (\gamma \bm u) \cdot \bm u = \gamma^3 \bm u \frac{d \bm u}{dt} = c^2 \frac{d\gamma}{dt} \)
